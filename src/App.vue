...
<div id="app" class="h-100">
  <div class="container-fluid h-100 p-0">
    ...
    <nav class="navbar navbar-expand-lg bg-dark mb-3">
      <a class="navbar-brand text-light">Protocol Editor</a>
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-light" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">New</a>
